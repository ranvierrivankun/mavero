...
class Request_material_model extends CI_Model
{
    ...
    // Ambil data dari table request_material
    public function get_request_material($id_material)
    {
        $this->db->select('a.*, a.id_material, a.name AS name_material, b1.name AS name_user, b2.name AS name_user_updated');
        ...
        if ($result) {
            if ($result->id_user_updated === null) {
